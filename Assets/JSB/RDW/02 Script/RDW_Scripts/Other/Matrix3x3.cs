...
// 출처: https://gist.github.com/anyuser/bf3b6b76937f778636771153d8ba4ff6
public struct Matrix3x3
{
	...
	public static Matrix3x3 CreateTRS(Vector2 translation, float rotation, Vector2 scale)
	{
		...
		Matrix3x3 m = new Matrix3x3();
		m.m00 = scale.x * cos;
		m.m01 = scale.y * -sin; // TODO: 틀린건가?
		m.m02 = translation.x;
		m.m10 = scale.x * sin; // TODO: 틀린건가?
		m.m11 = scale.y * cos;
		m.m12 = translation.y;
		m.m20 = 0;
		m.m21 = 0;
	...
	public static Matrix3x3 MultiplyMatrix3x3(Matrix3x3 m1, Matrix3x3 m2) // m1 * m2
	{
		Matrix3x3 m = new Matrix3x3();

		m.m00 = m2.m00 * m1.m00 + m2.m10 * m1.m01 + m2.m20 * m1.m02;
		m.m10 = m2.m00 * m1.m10 + m2.m10 * m1.m11 + m2.m20 * m1.m12;
		m.m20 = m2.m00 * m1.m20 + m2.m10 * m1.m21 + m2.m20 * m1.m22;
		m.m01 = m2.m01 * m1.m00 + m2.m11 * m1.m01 + m2.m21 * m1.m02;
		m.m11 = m2.m01 * m1.m10 + m2.m11 * m1.m11 + m2.m21 * m1.m12;
		m.m21 = m2.m01 * m1.m20 + m2.m11 * m1.m21 + m2.m21 * m1.m22;
		m.m02 = m2.m02 * m1.m00 + m2.m12 * m1.m01 + m2.m22 * m1.m02;
		m.m12 = m2.m02 * m1.m10 + m2.m12 * m1.m11 + m2.m22 * m1.m12;
		m.m22 = m2.m02 * m1.m20 + m2.m12 * m1.m21 + m2.m22 * m1.m22;
		return m;
	}
	...
	public override string ToString()
	{
		...
		return string.Format("[Matrix3x3: det={9} m00={0}, m01={1}, m02={2}, m10={3}, m11={4}, m12={5}, m20={6}, m21={7}, m22={8}]", m00, m01, m02, m10, m11, m12, m20, m21, m22, det);
	}
}
